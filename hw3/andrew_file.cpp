...
void moveRight(vector<vector<char>> &matrix, size_t row,
...
void moveDown(vector<vector<char>> &matrix, size_t row,
              size_t col) // Need to implement
{
  Stack s;
  int counter = 0;
...
void moveLeft(vector<vector<char>> &matrix, size_t row,
              size_t col) // Need to implement
{
  Stack s;
  int counter = 0;
